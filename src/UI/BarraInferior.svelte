<script>
  ...
  function sobre() {
    Swal.fire({
      title: "Sobre",
      html: `<style> .bold { font-weight: bold; } .italic { font-style: italic;}
      a {text-decoration: none; color: inherit; } </style>
      <p>
...
<style>
  .barra {
    ...
    -moz-box-shadow: rgba(100, 100, 111, 0.2) 0 -7px 29px 0;
...
<div class="barra">
  ...
  >
  <span>
    <button on:click={sobre}>Sobre</button> •
    <button>
